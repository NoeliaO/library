...
export class YourBooksComponent {
  libros = [
    {
      rutaPortada:
        'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSpDRF2omCJKXQbo3VDWmRzqiXamnlc4V8ozPwXnuCZHQ&s',
      ...
      enlaceAmazon:
        'https://www.amazon.es/Harry-Potter-Piedra-Filosofal-Rowling/dp/8478884459',
    },
    {
      rutaPortada:
        'https://www.estudioenescarlata.com/media/img/portadas/_visd_0001JPG01M53.jpg',
      ...
      enlaceAmazon:
        'https://www.amazon.es/Senor-Los-Anillos-Comunidad-Fellowship/dp/9505470673/ref=sr_1_5?__mk_es_ES=%C3%85M%C3%85%C5%BD%C3%95%C3%91&keywords=la+comunidad+del+anillo&qid=1673740692&sr=8-5',
    },
    {
      rutaPortada:
        'https://imagessl4.casadellibro.com/a/l/t7/04/9788466658904.jpg',
      tituloLibro: 'El pozo de la ascension',
      resumen:
      ...
      enlaceAmazon:
        'https://www.amazon.es/Pozo-Ascensi%C3%B3n-Nacidos-bruma-Mistborn-ebook/dp/B00AR07H9A',
    },
  ];
}
